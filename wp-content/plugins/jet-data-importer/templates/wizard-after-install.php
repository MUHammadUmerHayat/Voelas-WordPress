...
} elseif ( function_exists( 'rx_theme_wizard_interface' ) ) {
	$skin     = rx_theme_wizard_interface()->get_skin_data( 'slug' );
	$referrer = 'rx-theme-wizard';
}
...
<?php esc_html_e( 'Your theme is ready for demo data importing. Do you want to append demo content to your existing content or completely rewrite it?', 'jet-data-importer' ); ?>
<form method="get" action="<?php echo esc_url( admin_url( 'admin.php' ) ); ?>">
	...
	<button class="btn btn-primary" data-wizard="confirm-install" data-loader="true" data-href=""><span class="text"><?php
		esc_html_e( 'Import Data', 'jet-data-importer' );
