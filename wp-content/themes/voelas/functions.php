...
if ( ! class_exists( 'Rvdx_Theme_Setup' ) ) {
	...
	class Rvdx_Theme_Setup {
		...
		public function l10n() {
			 ...
			 */
			load_theme_textdomain( 'voelas', get_theme_file_path( 'languages' ) );
		...
		public function includes() {
			...
			*/
			 ...
			 */
			require_once get_theme_file_path( '/admin/update/update-base.php' );
			require_once get_theme_file_path( '/admin/update/update.php' );
		...
		public function register_assets() {
			...
			wp_register_script(
				'sine-waves',
				get_theme_file_uri( 'assets/lib/sine-waves/sine-waves.min.js' ),
				array(),
				'0.3.0',
				true
			);
			...
			wp_register_script(
				'jquery-slick',
				get_theme_file_uri( 'assets/lib/slick/slick.min.js' ),
					array(),
				'1.8.1',
				true
			);
		...
		public function enqueue_admin_styles() {
			...
			wp_enqueue_style(
				'voelas-custom-admin',
				get_theme_file_uri( 'admin/css/voelas-admin.css' ),
				array(),
				$this->version()
			);
			...
			if ( ! df_is_theme_activated() ) {
				wp_enqueue_script(
					'voelas-custom-js-admin',
					get_theme_file_uri( 'admin/js/voelas-admin.js' ),
					array(),
					$this->version()
				);
			}
